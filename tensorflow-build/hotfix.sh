...
sed -i 's/echo/<LIST>/g'  /workspace/host/tensorflow-pack/tensorflow-build/srcs.lst
sed -i '$a </LIST>' /workspace/host/tensorflow-pack/tensorflow-build/srcs.lst
sed -i 's/echo/<LIST>/g' /workspace/host/tensorflow-pack/tensorflow-build/srcs.cmsis-nn.lst
sed -i '$a </LIST>' /workspace/host/tensorflow-pack/tensorflow-build/srcs.cmsis-nn.lst
sed -i 's/echo/<LIST>/g' /workspace/host/tensorflow-pack/tensorflow-build/srcs.ethos.lst
sed -i '$a </LIST>' /workspace/host/tensorflow-pack/tensorflow-build/srcs.ethos.lst

sed -i 's/echo/<LIST>/g' /workspace/host/tensorflow-pack/tensorflow-build/hdrs.lst
sed -i '$a </LIST>' /workspace/host/tensorflow-pack/tensorflow-build/hdrs.lst
sed -i 's/echo/<LIST>/g' /workspace/host/tensorflow-pack/tensorflow-build/hdrs.cmsis-nn.lst
sed -i '$a </LIST>' /workspace/host/tensorflow-pack/tensorflow-build/hdrs.cmsis-nn.lst
sed -i 's/echo/<LIST>/g' /workspace/host/tensorflow-pack/tensorflow-build/hdrs.ethos.lst
sed -i '$a </LIST>' /workspace/host/tensorflow-pack/tensorflow-build/hdrs.ethos.lst
...
sed -i 's/tensorflow\/lite\/micro\/kernels\/conv_test_common.cc / /' /workspace/host/tensorflow-pack/tensorflow-build/srcs.ethos.lst
...
sed -i 's/tensorflow\/lite\/micro\/system_setup.cc / /' /workspace/host/tensorflow-pack/tensorflow-build/srcs.ethos.lst
...
sed -i 's/tensorflow\/lite\/micro\/micro_time.cc / /' /workspace/host/tensorflow-pack/tensorflow-build/srcs.ethos.lst
...
sed -i 's/tensorflow\/lite\/micro\/cortex_m_generic\/micro_time.cc / /' /workspace/host/tensorflow-pack/tensorflow-build/srcs.ethos.lst
...
sed -i 's/tensorflow\/lite\/micro\/debug_log.cc / /' /workspace/host/tensorflow-pack/tensorflow-build/srcs.ethos.lst
...
sed -i 's/tensorflow\/lite\/micro\/cortex_m_generic\/debug_log.cc / /' /workspace/host/tensorflow-pack/tensorflow-build/srcs.ethos.lst
