...
#define TOTAL_S_ROM_SIZE          (0x00040000) /* 256 KiB */

/* Secure Data */
#define S_RAM_ALIAS               (0x30000000) /* DTCM_BASE_S */
#define TOTAL_S_RAM_SIZE          (0x00040000) /* 256 KiB */


/* Non-Secure Code */
#define NS_ROM_ALIAS              (0x21000000) /* VM0_BASE_NS */
#define TOTAL_NS_ROM_SIZE         (0x00040000) /* 256 KiB */

/* Non-Secure Data */
#define NS_RAM_ALIAS              (0x21040000) /* VM1_BASE_NS */
#define TOTAL_NS_RAM_SIZE         (0x00040000) /* 256 KiB */
