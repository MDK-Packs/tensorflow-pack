...
# Upstream repository
UPSTREAM_URL="https://github.com/google/gemmlowp/archive/master.zip"
...
print ("./Utilities/"+packcheck_name, PACK_BUILD+"/"+PACK_VENDOR+"."+PACK_NAME+".pdsc", "-n PackName.txt")
...
print (os.getcwd())
with open (os.getcwd()+"/PackName.txt.test", "r") as packversion_file:
